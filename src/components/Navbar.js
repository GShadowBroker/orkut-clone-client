    ...
    <UpperNav>
      <Container nav>
        <ul>
          ...
          <li>Drive</li>
          <li>
            Mais <TiArrowSortedDown className="icenter" />
          </li>
        </ul>
        <ul>
          <li className="email-menu">{loggedUser.email}</li>
          <li className="left-menu" onClick={toggleConfig}>
            configurações
          </li>
          <li className="left-menu" onClick={() => logout()}>
            sair
          </li>
        </ul>
      </Container>
    ...
    <MainNav>
      <Container nav>
        ...
        <NavMenu>
          ...
          <Link
            to={`/perfil/${loggedUser.id}`}
            className={
              location.pathname === `/perfil/${loggedUser.id}` ? "active" : ""
            }
          >
            Perfil
          </Link>
          <Link
            to={`/perfil/${loggedUser.id}/scraps`}
            className={
              location.pathname === `/perfil/${loggedUser.id}/scraps`
                ? "active"
                : ""
            }
          >
          ...
          <Link
            to={`/perfil/${loggedUser.id}/comunidades`}
            className={
              location.pathname === `/perfil/${loggedUser.id}/comunidades`
                ? "active"
                : ""
            }
          >
          ...
          <Link to="/">
            Aplicativos <TiArrowSortedDown className="icenter" />
          </Link>
          <Link to="/">
            Temas <TiArrowSortedDown className="icenter" />
          </Link>
        </NavMenu>
