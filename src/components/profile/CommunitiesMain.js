...
import { MainColumn, ProfileInfo, InlineHeader } from "../../styles/profile";
  ...
  return (
    <MainColumn>
      <Card>
        ...
        <ProfileInfo>
          <Subtitle2>
            Minhas comunidades gerenciadas ({managedCommCount || 0})
          </Subtitle2>
          <div
            style={{
    ...
    <Message>
      ...
      <MessageContent>
        <MessageHeaderSpaced>
          <Link to={`/comunidades/${community.id}`}>
            <strong>
              {trunc(community.title, 30)} ({communityCount})
            </strong>
          </Link>
