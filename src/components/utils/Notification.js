...
Notification.defaultProps = {
  ...
  message:
    "Infelizmente o servidor do aplicativo se comportou de forma inesperada. Por favor, recarregue a página ou aguarde alguns minutos.",
  severity: "high",
};
