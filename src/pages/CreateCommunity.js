...
const CreateCommunity = ({ loggedUser, mobile }) => {
  ...
  const [
    createNewCommunity,
    { loading: loadingCommunityCreation },
  ] = useMutation(CREATE_NEW_COMMUNITY, {
            ...
            <VerticalRadio>
              <RadioGroup>
                ...
                <label htmlFor="public">
                  pública - qualquer pessoa pode ver o conteúdo da comunidade
                </label>
              </RadioGroup>
              <RadioGroup>
                <Input
                ...
                <label htmlFor="private">
                  privada - apenas membros podem ver o conteúdo da comunidade
                </label>
              </RadioGroup>
            </VerticalRadio>
          </RegisterInputGroup>
