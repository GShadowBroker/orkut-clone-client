...
export const SearchInputIcon = styled.div`
  ...
  border: 1px solid #bebebe;
  border-right: ${(props) =>
    props.noborderright ? "none" : "1px solid #bebebe"};
  border-left: ${(props) =>
    props.noborderleft ? "none" : "1px solid #bebebe"};
  color: grey;
`;
...
export const FormUpdate = styled.form`
  ...
  padding: 0.6rem;
  border: ${(props) =>
    props.error ? "1px solid #e74c3c" : "1px solid #bebebe"};
`;
